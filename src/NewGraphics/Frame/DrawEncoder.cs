...
namespace RenderMaster.src.NewGraphics.Frame
{
    ...
    {
        public static void EncodeAndDraw(IReadOnlyList<ClassifiedDraw> draws, GPUResourceTable gpu)
        {
            ...
            foreach (var d in draws)
            {
                ...
                if (d.Pass != currentPass)
                {
                    ...
                    currentPass = d.Pass;
                    // Changing pass invalidates cached bindings in conservative way.
                    currentVao = -1;
                    lastMaterialId = -1;
                }

                // Material textures (if any)
            ...
            // Restore defaults that might be expected by other systems (conservative)
